...
The condition number reflects how sensitive the value of a function is to perturbations in its input. It does not depend on the numerical method $\tilde{f}$ and indicates how hard it is to evaluate $f$ numerically, no matter which method is used.
...
$$
\begin{align*}
\kappa_2(A) = & \lim_{\delta\rightarrow 0} \sup_{A,A+\Delta A \in \mathbb{R}^{n \times n} \atop 0 < \| \Delta A \| \leq \delta} \frac{\| f_2(A+\Delta A) - f_2(A) \|_{\mathbb{R}^{n}} / \| f_2(A) \|_{\mathbb{R}^{n}}}{\| \Delta A \|_{\mathbb{R}^{n \times n}} / \| A \|_{\mathbb{R}^{n \times n}}} \\
= & \lim_{\delta\rightarrow 0} \sup_{A,A+\Delta A \in \mathbb{R}^{n \times n} \atop 0 < \| \Delta A \| \leq \delta} \frac{\| \Delta y \|_{\mathbb{R}^{n}} / \| y \|_{\mathbb{R}^{n}}}{\| \Delta A \|_{\mathbb{R}^{n \times n}} / \| A \|_{\mathbb{R}^{n \times n}}} \leq \|A^{-1}\|\cdot \|A\|.
\end{align*}
$$
...
The condition number $\kappa_2(A)$ has an important interpretation. It measures how close the matrix is to being singular. More precisely,
