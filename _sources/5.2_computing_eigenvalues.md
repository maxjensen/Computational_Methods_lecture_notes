...
$$
(A - \lambda_1 x_1^T x_1)^i q^{(0)} = (\alpha_1\lambda_1^i x_1 - \alpha_1\lambda_1^i x_1) + \sum_{j=2}^n\alpha_j\lambda_j^i x_j = \alpha_2\lambda_2^{i}\left(x_2+\sum_{j \geq 3}\frac{\alpha_j}{\alpha_2}\left(\frac{\lambda_j}{\lambda_2}\right)^i x_j\right).
$$
