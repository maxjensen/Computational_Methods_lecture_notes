...
:label: def-big-o-at-infinity
Let $g(x)$ and $f(x)$ be functions defined for $x \in \mathbb{X}$, $\mathbb{X} \in \{ \mathbb{N}, \mathbb{R} \}$. If there exist an $x_0 \in \mathbb{X}$ and a constant $C > 0$ such that
...
:label: def-big-o-at-point
Let $g(x)$ and $f(x)$ be functions defined for $x \in \mathbb{X}$, $\mathbb{X} \in \{ \mathbb{N}, \mathbb{R} \}$. If there exist a $\delta > 0$ and a constant $C > 0$ such that
...
In most cases, when studying approximations near a finite point $y$, $f$ is chosen so that $f(x) \to 0$ as $x \to y$.

<!--
```{prf:example} Highest-order coefficient
:label: ex-big-o-highest-order-at-infinity
...
```{prf:example} Highest-order coefficient
:label: ex-big-o-highest-order-at-point
