...
Chebychev polynomials are considered on the reference interval $[-1,1]$ with only a few exceptions. We shall use the terms Chebychev polynomial of the first kind and Chebychev polynomial synonymously.
