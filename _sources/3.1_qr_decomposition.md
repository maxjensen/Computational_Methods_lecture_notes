...
$$
\sum_{j=1}^{k-1}\langle a_k, q_j \rangle q_j = \sum_{j=1}^{k-1} \frac{\langle a_k, \tilde{q}_j \rangle}{\langle \tilde{q}_j, \tilde{q}_j \rangle} \tilde{q}_j.
$$
...
1. Starting with $\tilde{q}_0(t)=1$, we compute
   ...
   $$
   \begin{align*}
   &\tilde{q}_1(t) = a_1(t) - \frac{(\tilde{q}_0,a_1)}{(\tilde{q}_0,\tilde{q}_0)} = t - 0,\\
   &\tilde{q}_2(t) = a_2(t) - \frac{(\tilde{q}_1,a_2)}{(\tilde{q}_1,\tilde{q}_1)}\tilde{q}_1(t)
 - \frac{(\tilde{q}_0,a_2)}{(\tilde{q}_0,\tilde{q}_0)}\tilde{q}_0(t)
 = t^2 - 0 - \frac13,\\
   &\tilde{q}_3(t) = a_3(t) - \frac{(\tilde{q}_2,a_3)}{(\tilde{q}_2,\tilde{q}_2)}\tilde{q}_2(t)
 - \frac{(\tilde{q}_1,a_3)}{(\tilde{q}_1,\tilde{q}_1)}\tilde{q}_1(t)
 - \frac{(\tilde{q}_0,a_3)}{(\tilde{q}_0,\tilde{q}_0)}\tilde{q}_0(t)
   = t^3 - 0 - \frac{3t}5 - 0.
   \end{align*}
   $$
...
2. Starting with $\tilde{q}_0(t)=1$, we compute
   ...
   $$
   \begin{align*}
   \tilde{q}_1(t) & = a_1(t) - \frac{(\tilde{q}_0,a_1)}{(\tilde{q}_0,\tilde{q}_0)} = t - \frac12,\\
   \tilde{q}_2(t) & = a_2(t) - \frac{(\tilde{q}_1,a_2)}{(\tilde{q}_1,\tilde{q}_1)}\tilde{q}_1(t)
 - \frac{(\tilde{q}_0,a_2)}{(\tilde{q}_0,\tilde{q}_0)}\tilde{q}_0(t)
...
3. Finally, starting with $\tilde{q}_0(t)=1$, we compute:
   ...
   $$
   \begin{align*}
   \tilde{q}_1(t) & = a_1(t) - \frac{(\tilde{q}_0,a_1)}{(\tilde{q}_0,\tilde{q}_0)} = t - \frac{\exp-2}{\exp-1} = t - 0.4180232931,\\
   \tilde{q}_2(t) & = a_2(t) - \frac{(\tilde{q}_1,a_2)}{(\tilde{q}_1,\tilde{q}_1)}\tilde{q}_1(t)
 - \frac{(\tilde{q}_0,a_2)}{(\tilde{q}_0,\tilde{q}_0)}\tilde{q}_0(t)\\
