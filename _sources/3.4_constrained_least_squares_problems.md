...
4. **Remark:** We can solve the problem with CVXPY, using the below code. The optimal solution achieves approximately 189 grams per kile at a cost of 6 pounds. This code implements the least-squares problem in its original form. If a certificate of optimimality is needed, adapt the code of the Python skills section to solve this problem.
